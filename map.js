...
pin.image.propertyFields.href = "flag";
...
pin.image.propertyFields.href = "flag";
    ...
    pin.events.on("hit", function (ev) {
        ...
        setTimeout(function() {
          var popup = chart.openPopup("<strong>" + ev.target.dataItem.dataContext.title + "</strong>" + "<br>" + ev.target.dataItem.dataContext.text );
          popup.left = ev.svgPoint.x + 15;
          popup.top = ev.svgPoint.y + 15;
        }, 10);
      
      // setTimeout(function() {
      //   var popup = chart.openPopup("We clicked on <strong>" + ev.target.dataItem.dataContext.title + "</strong>");
      //   popup.left = ev.svgPoint.x + 15;
      //   popup.top = ev.svgPoint.y + 15;
      // }, 10);
      // chart.closeAllPopups();
